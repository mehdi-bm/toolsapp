class ImageCompressionHistoryEntry {
  const ImageCompressionHistoryEntry({
  ...
  static ImageCompressionHistoryEntry? tryParse(Map<String, dynamic> json) {
    ...
    return ImageCompressionHistoryEntry(
      sourceName: sourceName,
      outputPath: outputPath,
      originalSize: originalSize,
      compressedSize: compressedSize,
